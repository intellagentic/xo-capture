...
function ResultsScreen({ setShowModal, clientId, isAdmin,systemButtons,theme,preferredModel, activeEngagement, setActiveEngagement, onNavigate }) {
  ...
  const [formattedResults,setFormattedResults] = useState([
    ...
    {id:"componentMapping",icon:"Database",name:"Component Mapping",shortDescription:"FITS / EXTENDS / NEW classification",severity: 'medium'},
            ...
            {exp && expandedResult && (
                <div style={{
                ...
                }}>
                  {
                    ...
                    (expandedResult.id==="componentMapping"?
                        <div style={{ padding: '1.25rem' }}>
                          {displayResults.component_mapping ? (() => {
                          ...
                          })() : <div style={{ padding: '1rem', color: '#6b7280', fontSize: '0.85rem' }}>No component mapping data. Re-enrich to generate.</div>}
                        </div>:
