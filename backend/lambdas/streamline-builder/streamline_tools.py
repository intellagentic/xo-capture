...
- steps: array of objects, each with:
  ...
  - type: one of: data_capture, new_logic_step, notification, document, incoming_webhook, outbound_webhook, collaboration, sign, extract_data_from_files, data_search, deliver_data, transform
